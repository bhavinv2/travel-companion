...
export default function Footer() {
  return (
    <footer id="about" style={{ background: 'var(--navy)', padding: '64px 0 32px', color: '#C9D5F0' }}>
      <div className="wrap">
        <div className="fgrid">
          <div className="fbrand">
            <a className="logo" href="#top" aria-label="NRI Parent Service home" style={{ color: '#fff' }}>
              <span className="logo-mark" style={{ background: 'rgba(255,255,255,.12)' }}>
                <Icon name="i-shield" className="ico w" />
              </span>
            ...
            <span className="script-tag" style={{ fontSize: 22, color: 'var(--marigold)', marginTop: 10, display: 'block' }}>Until your next journey.</span>
